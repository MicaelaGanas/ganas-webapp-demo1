    ...
    >
      ...
      <div className="mt-10 grid gap-10 lg:grid-cols-[320px_minmax(0,1fr)]">
        ...
        <div className="space-y-6">
          <div className="rounded-[2.5rem] border border-slate-200 bg-white p-8 shadow-2xl transition duration-500 hover:-translate-y-2 hover:shadow-[0_30px_90px_-45px_rgba(14,165,233,0.7)] dark:border-slate-700 dark:bg-slate-800">
