...
const previewConfigs = {
  mobile: {
    label: "Mobile",
    classes:
      "grid gap-4 rounded-3xl bg-white/90 p-6 shadow-lg lg:grid-cols-1 dark:bg-slate-800/90",
    content: [
      "Stacked cards",
      "Buttons full width",
      "Typography 16px",
  ...
  tablet: {
    label: "Tablet",
    classes:
      "grid gap-4 rounded-3xl bg-white/90 p-6 shadow-lg sm:grid-cols-2 dark:bg-slate-800/90",
    content: [
      "Two-column split",
      "Buttons inline",
      "Typography 18px",
  ...
  desktop: {
    label: "Desktop",
    classes:
      "grid gap-4 rounded-3xl bg-white/90 p-6 shadow-lg md:grid-cols-[2fr_1fr] dark:bg-slate-800/90",
    content: [
      "Sidebar adds",
      "Buttons compact",
      "Typography 18-20px",
    ...
    >
      ...
      <div className="mt-10 grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
        ...
        <div className="space-y-6">
          <div className="rounded-[2.5rem] border border-slate-200 bg-gradient-to-br from-slate-900/90 via-slate-900/80 to-slate-800 p-10 text-white shadow-2xl transition duration-500 hover:-translate-y-2 hover:shadow-[0_30px_90px_-45px_rgba(14,165,233,0.7)] dark:border-slate-700">
